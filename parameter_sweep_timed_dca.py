...
if __name__ == '__main__':
    ...
    strategies = [TimedDCA for _ in range(len(param_grid))]
    ...
    save_parameter_sweep_heatmap(
        ...
        param_dca_portion, 
        param_threshold, 
        'Timed DCA Parameter Sweep (Price Only)', 
        'Mean 10 Year Returns (%)', 
        'Fixed Contribution Portion (%)', 
        'Market Dip Threshold (%)', 
        path_join(PATH_CHART_ROOT, 'timed_dca_parameter_sweep_PO.png'))
    ...
    save_parameter_sweep_heatmap(
        ...
        param_dca_portion, 
        param_threshold, 
        'Timed DCA Parameter Sweep (Total Return)', 
        'Mean 10 Year Returns (%)', 
        'Fixed Contribution Portion (%)', 
        'Market Dip Threshold (%)', 
        path_join(PATH_CHART_ROOT, 'timed_dca_parameter_sweep_TR.png'))